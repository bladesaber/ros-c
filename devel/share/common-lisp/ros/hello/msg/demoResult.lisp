...
(cl:defmethod cl:initialize-instance :after ((m <demoResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'demoResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hello-msg:<demoResult> is deprecated: use hello-msg:demoResult instead.")))

(cl:ensure-generic-function 'final_count-val :lambda-list '(m))
(cl:defmethod final_count-val ((m <demoResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hello-msg:final_count-val is deprecated.  Use hello-msg:final_count instead.")
  (final_count m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<demoResult>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%#part2: the result message, to be sent by the server upon completion~%int32 final_count~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'demoResult)))
  "Returns full string definition for message of type 'demoResult"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%#part2: the result message, to be sent by the server upon completion~%int32 final_count~%~%~%"))
