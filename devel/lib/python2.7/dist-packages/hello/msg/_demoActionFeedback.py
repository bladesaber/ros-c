...
"""autogenerated by genpy from hello/demoActionFeedback.msg. Do not edit."""
import sys
...
class demoActionFeedback(genpy.Message):
  _md5sum = "3f95345e5c05f25b3ff151f159a87ba1"
  _type = "hello/demoActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','hello/demoFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = hello.msg.demoFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = hello.msg.demoFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.feedback.current_count
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.current_count,) = _get_struct_i().unpack(str[start:end])
      return self
